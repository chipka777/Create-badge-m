...
<div class="main">
	...
	<img class="dash-logo" src="img/badgem-bwlogo.png" />
	
	<div class="navigation">
		<img src="img/feed.png" id="feed" class="active" onclick="getFeed()"/>
		<img src="img/instagram.png" id="insta" onclick="getInsta()"/>
		<img src="img/shop.png" id="shop"/>
	</div>
	<div class="nav-panels">
		<div id="feed-panel" class="nav-panel show">
			...
			<br>OR<br>
			<button class="file-btn">UPLOAD AN IMAGE</button>
			
		</div>
		<div id="insta-panel" class="nav-panel">INSTA</div>
		
		<div id="shop-panel" class="nav-panel">SHOP</div>
		
		
	</div>


<button class="prev" page-value="1">Prev</button>
<button class="next" page-value="1">Next</button>
